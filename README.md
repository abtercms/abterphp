...
[![Build Status](https://github.com/abtercms/abterphp/actions/workflows/ci.yml/badge.svg?branch=monorepo)](https://github.com/abtercms/abterphp/actions)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/abtercms/abterphp/badges/quality-score.png?b=monorepo)](https://scrutinizer-ci.com/g/abtercms/abterphp/?branch=monorepo)
[![Build Status](https://scrutinizer-ci.com/g/abtercms/abterphp/badges/build.png?b=main)](https://scrutinizer-ci.com/g/abterphp/abterphp/build-status/monorepo)
![Coverage Status](https://raw.githubusercontent.com/abtercms/abterphp/monorepo/coverage.svg)
## Installation
...
ensure that you have the right version of PHP, with the necessary modules and that you have at least a supported version
...
The recommended way is using `mkcert`. While it is not necessarily mandatory, some
