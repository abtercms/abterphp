...
INSERT INTO `admin_resources` (`identifier`) VALUES ('adminresources'), ('users'), ('usergroups'), ('usergroups_adminresources');
...
INSERT INTO `user_groups` (`identifier`, `name`) VALUES ('admin','Admin');
...
CREATE TABLE `user_groups_admin_resources` (
  ...
  `admin_resource_id` int(10) unsigned NOT NULL DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
...
INSERT INTO `user_languages` (`identifier`, `name`) VALUES ('en','English'),('hu','Hungarian');
