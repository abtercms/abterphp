...
class RequestBuilder
{
     ...
     */
    public function __construct(BaseTestCase $integrationTest, string $method, string $url = null)
    {
     ...
     *
     * @return BaseTestCase The application test case that created this
     * @throws InvalidArgumentException Thrown if the build request is invalid
     */
    public function go() : BaseTestCase
    {
        $this->validate();
