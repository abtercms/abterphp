...
{
    /** @var BaseTestCase The integration test that created this */
    ...
    /**
     * @param BaseTestCase $integrationTest The integration test that created this builder
     * @param string $commandName The command name
     */
    public function __construct(BaseTestCase $integrationTest, string $commandName)
    {
     ...
     *
     * @return BaseTestCase For method chaining
     */
    public function execute() : BaseTestCase
    {
