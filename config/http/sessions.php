...
return [
     ...
     */
    'handler' => Environment::getVar(Env::SESSION_HANDLER, FileSessionHandler::class),
    'lifetime' => 7200,
     ...
     */
    'cookie.domain' => Environment::getVar(Env::SESSION_COOKIE_DOMAIN, ''),
    'cookie.isHttpOnly' => true,
    'cookie.isSecure' => Environment::getVar(Env::SESSION_COOKIE_IS_SECURE, false),
    'cookie.path' => Environment::getVar(Env::SESSION_COOKIE_PATH, '/'),
     ...
     */
    'cache.bridge' => Environment::getVar(Env::SESSION_CACHE_BRIDGE, FileBridge::class),
    'cache.clientName' => 'session',
