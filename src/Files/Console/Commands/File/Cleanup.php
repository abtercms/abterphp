...
{
    protected const COMMAND_NAME            = 'files:cleanup';
    protected const COMMAND_DESCRIPTION     = 'Cleanup missing files both from database and filesystem';
    protected const COMMAND_SUCCESS         = '<success>Files are cleaned up.</success>';
    protected const COMMAND_DRY_RUN_MESSAGE = '<info>Dry run prevented deleting files and database rows.</info>';

    protected const OPTION_DRY_RUN    = 'dry-run';
    protected const SHORTENED_DRY_RUN = 'd';

    protected const DELETING_FILES    = 'Deleting files missing from database:';
    protected const DELETING_ENTITIES = 'Deleting database entities missing from filesystem:';

    protected const FS_ONLY = 'Files to delete: %d';
    protected const DB_ONLY = 'Database entities to delete: %d';
    ...
    /** @var string[] */
    protected array $filesToSkip = ['.gitignore', '.gitkeep'];
