...
class FileCategory extends FormAbstract
{
    ...
    public const ENTITY_TITLE_SINGULAR = 'files:fileCategory';
    public const ENTITY_TITLE_PLURAL   = 'files:fileCategories';

    public const ROUTING_PATH = 'file-categories';

    protected AssetManager $assetManager;

    protected string $resource = 'file_categories';
