...
namespace AbterPhp\Framework\Tests\Module;

use AbterPhp\Framework\Constant\Event;
use AbterPhp\Framework\Constant\Module;
use AbterPhp\Framework\Module\Loader;
...
class ManagerTest extends TestCase
{
                ...
                [
                    [
                        Module::ROUTE_CONFIGURATORS => [
                            600   => [
                                'Routes\EarlyRouteConfigurator',
                                'Routes\Early2RouteConfigurator',
                            ],
                            50000 => [
                                'Routes\LateRouteConfigurator',
                            ],
                        ],
                    ],
                ],
            ...
            'two-modules' => [
                [
                    ...
                    [
                        Module::ROUTE_CONFIGURATORS => [
                            -20   => [
                                'Routes\ReallyEarlyRouteConfigurator',
                            ],
                            700   => [
                                'Routes\EarlyRouteConfigurator',
                            ],
    ...
    public function testGetRoutePaths(array $modules, array $expectedResult): void
    {
        ...
        $actualResult = $this->sut->getRouteConfigurators();
