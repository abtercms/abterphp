...
namespace AbterPhp\Framework\Tests\Bootstrappers\Cache;

use AbterPhp\Framework\Bootstrappers\Cache\CacheBootstrapper;
...
class CacheBootstrapperTest extends TestCase
{
    ...
    {
        Config::set('cache', 'file.path', '/tmp/cache-test');
