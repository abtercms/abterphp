...
namespace AbterPhp\Framework\Tests\Grid\Filter;

use AbterPhp\Framework\Grid\Filter\IFilter;
use AbterPhp\Framework\Grid\Filter\RegexpFilter;

class RegexpFilterTest extends FilterTest
{
    /**
     * @return array
     */
    public function getWhereConditionsProvider(): array
    {
        return [
            ...
            'matching-param'    => [['filter-foo' => 'ABC'], ['foo_field REGEXP ?']],
        ];
    }
    ...
    {
        return new RegexpFilter($inputName, $fieldName);
    }
}
