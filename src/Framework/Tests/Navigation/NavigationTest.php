...
namespace AbterPhp\Framework\Tests\Navigation;
...
class NavigationTest extends TestCase
{
    ...
    public function testToStringWithOptionalsModified(): void
    {
        ...
        $sut->setWrapper(new Tag('YYY', [], [], 'foo'));
        $sut->getPrefix()->setContent(new Tag('XXX', [], [], 'bar'));
        $sut->getPostfix()->setContent(new Tag('ZZZ', [], [], 'baz'));
