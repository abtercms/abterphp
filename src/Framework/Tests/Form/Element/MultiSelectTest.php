...
namespace AbterPhp\Framework\Tests\Form\Element;
    ...
    public function renderProvider(): array
    {
        ...
        return [
            'simple'               => [
                ...
                null,
                null,
                '<select id="abc" name="bcd" multiple></select>',
            ],
            ...
            'extra attributes'     => [
                ...
                [],
                null,
                "<select$str id=\"abc\" name=\"bcd\" multiple></select>",
            ],
            'options'              => [
                'abc',
                'bcd',
                ...
                [],
                null,
                "<select$str id=\"abc\" name=\"bcd\" multiple><option value=\"bde\">BDE</option>\n<option value=\"cef\">CEF</option></select>", // phpcs:ignore
            ],
            'option selected'      => [
                'abc',
                'bcd',
