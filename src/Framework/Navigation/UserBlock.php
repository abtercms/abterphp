...
class UserBlock extends Tag
{
    ...
    public function __construct(
        ...
        $this->mediaLeft  = new Tag($this->getUserImage($username), [], [], Html5::TAG_DIV);
        $this->mediaBody  = new Tag($username, [], [], Html5::TAG_DIV);
        $this->mediaRight = new Tag(null, [], [], Html5::TAG_DIV);
    ...
    protected function getUserImage(string $username): INode
    {
        ...
        $attributes = [Html5::ATTR_SRC => $url, Html5::ATTR_ALT => $username];
        $img        = new Contentless([], $attributes, Html5::TAG_IMG);

        $style      = sprintf('background: url(%1$s) no-repeat;', $url);
        $attributes = [Html5::ATTR_CLASS => 'user-img', Html5::ATTR_STYLE => $style];
    ...
    protected function getDefaultUserImage(string $username): INode
    {
        ...
        return new Contentless([], [Html5::ATTR_SRC => $url, Html5::ATTR_ALT => $username], Html5::TAG_SPAN);
    }
