...
return [
    ...
    Module::BOOTSTRAPPERS      => [
        ...
        Bootstrappers\Database\PDOBootstrapper::class,
        ...
        Bootstrappers\Vendor\QBQueryBuilderBootstrapper::class,
    ...
    Module::ROUTE_CONFIGURATORS        => [
        Priorities::EXTREME_LOW   => [
            Routes\FallbackRouteConfigurator::class,
        ],
