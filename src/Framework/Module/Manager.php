...
class Manager
{
    ...
    public const CACHE_KEY_ROUTE_CONFIGURATORS = 'AbterPhp:RouteConfigurators';
    ...
    /**
     * @return array<int, string[]> prioritized IRouteConfigurator class names
     */
    public function getRouteConfigurators(): array
    {
        return $this->cacheWrapper(
            static::CACHE_KEY_ROUTE_CONFIGURATORS,
            $this->prioritizedOptionsCallback(Module::ROUTE_CONFIGURATORS, true)
        );
    }
    ...
    /**
     * Creates a callback that allows overriding previously defined options
     *
     * Examples
     * Module A: ['a' => 'a', 'b' => 'b']
     * Module B: ['b' => 'c', 'c' => 'd']
