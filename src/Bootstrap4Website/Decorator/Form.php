...
class Form extends Decorator
{
    ...
    public const DEFAULT_BUTTONS_CLASS    = 'form-group pmd-textfield pmd-textfield-floating-label';
    public const DEFAULT_BUTTON_CLASS     = 'pmd-checkbox-ripple-effect';

    public const CHECKBOX_GROUP_CLASS = 'checkbox pmd-default-theme';
    public const CHECKBOX_LABEL_CLASS = 'pmd-checkbox pmd-checkbox-ripple-effect';
