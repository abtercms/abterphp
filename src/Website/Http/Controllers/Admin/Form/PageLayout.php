...
class PageLayout extends FormAbstract
{
    ...
    public const ENTITY_TITLE_SINGULAR = 'website:pageLayout';
    public const ENTITY_TITLE_PLURAL   = 'website:pageLayouts';

    public const ROUTING_PATH = 'page-layouts';

    /** @var AssetManager */
    protected AssetManager $assetManager;

    /** @var string */
    protected string $resource = 'page_layouts';
