...
{
    public const ENTITY_SINGULAR = 'pageCategory';
    public const ENTITY_PLURAL   = 'pageCategories';

    public const ENTITY_TITLE_SINGULAR = 'website:pageCategory';
    public const ENTITY_TITLE_PLURAL   = 'website:pageCategories';

    public const ROUTING_PATH = 'page-categories';

    /** @var AssetManager */
    protected AssetManager $assetManager;

    /** @var string */
    protected string $resource = 'page_categories';
