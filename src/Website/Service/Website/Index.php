...
class Index
{
    ...
    public function getRenderedPage(string $identifier, array $userGroupIdentifiers): Entity
    {
        ...
        $ledeLines  = TagHelper::wrapByLines($page->getLede(), Html5::TAG_P);
        $attributes = Attributes::fromArray([Html5::ATTR_CLASS => 'lede']);
        $lede       = TagHelper::toString(Html5::TAG_DIV, $ledeLines, $attributes);
