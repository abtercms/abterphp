...
namespace AbterPhp\Website\Tests\Template\Builder\ContentList;

use AbterPhp\Framework\Constant\Html5;
use AbterPhp\Framework\Template\ParsedTemplate;
use AbterPhp\Website\Template\Builder\ContentList\DefinitionList;
use AbterPhp\Website\Template\Builder\ContentList\IContentList;

class DefinitionListTest extends ContentListTest
{
    /** @var DefinitionList - System Under Test */
    protected DefinitionList $sut;
...
EOD;
    ...
    public function testBuildDefault(
        ...
        $body         = $actualResult->getTemplates()['body'];
