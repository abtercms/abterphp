...
namespace AbterPhp\Website\Tests\Grid\Factory\Table;

use AbterPhp\Admin\Grid\Factory\Table\BodyFactory;
use AbterPhp\Framework\Grid\Table\Table;
use AbterPhp\Website\Grid\Factory\Table\ContentList;
...
class ContentListTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sut = new ContentList($this->headerFactoryMock, $this->bodyFactoryMock);
    }
