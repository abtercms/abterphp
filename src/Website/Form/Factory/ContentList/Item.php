...
class Item
{
    ...
    protected array $hiddenAttribs;

    public function __construct()
    {
        $this->hiddenAttribs = Attributes::fromArray([Html5::ATTR_TYPE => Input::TYPE_HIDDEN]);
    }
    ...
    protected function addIsDeleted(): INode
    {
        ...
        $help  = new Tag('website:contentListItemIsDeletedHelp');
