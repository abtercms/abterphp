...
{
    protected const BTN_CONTENT_PUBLISH_AND_EDIT       = 'website:publishAndEdit';
    protected const BTN_CONTENT_SAVE_AS_DRAFT_AND_EDIT = 'website:saveAsDraftAndEdit';

    protected const BTN_ID_DRAFT          = 'draft-btn';
    protected const BTN_ID_PUBLISH        = 'publish-btn';
    protected const IS_DRAFT_CONTAINER_ID = 'is-draft-container';
    protected const LAYOUT_FORM_GROUP_ID  = 'layout-div';

    protected const DESCRIPTION_ATTRIBS            = [Html5::ATTR_CLASS => FormGroup::CLASS_COUNTABLE];
    protected const IS_DRAFT_ATTRIBS               = [Html5::ATTR_ID => self::IS_DRAFT_CONTAINER_ID];
    protected const LAYOUT_FORM_GROUP_ATTRIBS      = [Html5::ATTR_ID => self::LAYOUT_FORM_GROUP_ID];
    protected const PUBLISH_AND_EDIT_ATTRIBS       = [
        ...
        Html5::ATTR_ID    => [self::BTN_ID_PUBLISH],
    ];
    protected const SAVE_AS_DRAFT_AND_BACK_ATTRIBS = [
        Html5::ATTR_NAME  => [DefaultButtons::BTN_NAME_NEXT],
        Html5::ATTR_TYPE  => [Button::TYPE_SUBMIT],
        Html5::ATTR_VALUE => [DefaultButtons::BTN_VALUE_NEXT_EDIT],
        Html5::ATTR_ID    => [self::BTN_ID_DRAFT],
    ];

    protected PageCategoryRepo $categoryRepo;

    protected PageLayoutRepo $layoutRepo;

    protected MetaFactory $metaFactory;

    protected AssetsFactory $assetsFactory;
    ...
    protected function addDescription(Entity $entity): Page
    {
        ...
        $this->form[] = new FormGroup($input, $label, $help, [], static::DESCRIPTION_ATTRIBS);
    ...
    {
        $input = new Textarea('lede', 'lede', $entity->getLede());
    ...
    {
        $input = new Textarea('body', 'body', $entity->getBody(), [], Textarea::EDITOR_ATTRIBS);
    ...
    {
        $input = new Textarea('layout', 'layout', $entity->getLayout());
    ...
    {
        $attributes = Input::getRawCheckboxAttribs($entity->isDraft());
        $input      = new Input('is_draft', 'is_draft', '1', [], $attributes);
        $label      = new Label('is_draft', 'website:pageIsDraft');
        $help       = new Tag('website:pageIsDraft');

        $this->form[] = new CheckboxGroup($input, $label, $help, [], static::IS_DRAFT_ATTRIBS);
    ...
    public function addPublishAndEdit(DefaultButtons $buttons): DefaultButtons
    {
        $buttons[] = new Button(
            ...
            static::PUBLISH_AND_EDIT_ATTRIBS
        );
    ...
    public function addSaveAsDraftAndBack(DefaultButtons $buttons): DefaultButtons
    {
        $buttons[] = new Button(
            ...
            static::SAVE_AS_DRAFT_AND_BACK_ATTRIBS
        );
