...
{
    public const DEFAULT_FORM_GROUP_CLASS = 'form-group';
    public const DEFAULT_LABEL_CLASS      = 'control-label';
    public const DEFAULT_INPUT_CLASS      = 'form-control';
    public const DEFAULT_BUTTON_CLASS     = 'pmd-checkbox-ripple-effect';

    public const CHECKBOX_GROUP_CLASS = 'checkbox pmd-default-theme';

    protected const DEFAULT_BUTTONS_CLASS    = 'form-group pmd-textfield pmd-textfield-floating-label';

    protected const CHECKBOX_LABEL_CLASS = 'pmd-checkbox pmd-checkbox-ripple-effect';
    ...
    {
        $checkboxGroup->setAttribute(new Attribute(Html5::ATTR_CLASS, static::CHECKBOX_GROUP_CLASS));

        $checkboxGroup->getLabel()->setAttribute(new Attribute(Html5::ATTR_CLASS, static::CHECKBOX_LABEL_CLASS));
        $checkboxGroup->getInput()->removeAttribute(Html5::ATTR_CLASS);
    }
}
