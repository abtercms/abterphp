...
{
    protected const COMMAND_NAME        = 'userlanguage:list';
    protected const COMMAND_DESCRIPTION = 'List available user languages';
    ...
    {
        /** @var Entity[] $userLanguages */
        $userLanguages = $this->userLanguageRepo->getAll();

        foreach ($userLanguages as $userLanguage) {
            assert($userLanguage instanceof Entity);
