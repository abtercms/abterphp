...
{
    protected const COMMAND_NAME            = 'apiclient:create';
    protected const COMMAND_DESCRIPTION     = 'Creates a new API client';
    protected const COMMAND_SUCCESS         = '<success>New API client is created. ID: <b>%s</b></success>';
    protected const COMMAND_DRY_RUN_MESSAGE = '<info>Dry run prevented creating new API client.</info>';

    protected const ARGUMENT_USER        = 'user';
    protected const ARGUMENT_DESCRIPTION = 'description';
    protected const ARGUMENT_RESOURCES   = 'resources';
