...
{
    protected const COMMAND_NAME            = 'user:create';
    protected const COMMAND_DESCRIPTION     = 'Creates a new user';
    protected const COMMAND_SUCCESS         = '<success>New user is created.</success>';
    protected const COMMAND_DRY_RUN_MESSAGE = '<info>Dry run prevented creating new user.</info>';
    protected const COMMAND_UNSAFE_PASSWORD = '<fatal>Password provided is not safe.</fatal>';

    protected const ARGUMENT_USERNAME    = 'username';
    protected const ARGUMENT_EMAIL       = 'email';
    protected const ARGUMENT_PASSWORD    = 'password';
    protected const ARGUMENT_USER_GROUPS = 'usergroups';
    protected const ARGUMENT_USER_LANG   = 'lang';

    protected const OPTION_CAN_LOGIN       = 'can-login';
    protected const SHORTENED_CAN_LOGIN    = 'l';
    protected const OPTION_HAS_GRAVATAR    = 'has-gravatar';
    protected const SHORTENED_HAS_GRAVATAR = 'g';
    protected const OPTION_DRY_RUN         = 'dry-run';
    protected const SHORTENED_DRY_RUN      = 'd';
    protected const OPTION_UNSAFE          = 'unsafe';
