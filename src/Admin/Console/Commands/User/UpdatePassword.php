...
{
    protected const COMMAND_NAME            = 'user:update-password';
    protected const COMMAND_DESCRIPTION     = 'Update the password of an existing user';
    protected const COMMAND_SUCCESS         = '<success>User password is updated.</success>';
    protected const COMMAND_DRY_RUN_MESSAGE = '<info>Dry run prevented updating user password.</info>';
