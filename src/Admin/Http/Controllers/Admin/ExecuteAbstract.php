...
{
    protected const INPUT_NEXT = 'next';

    protected const URL_CREATE = '%s-create';

    protected const CREATE_SUCCESS = 'framework:create-success';
    protected const CREATE_FAILURE = 'framework:create-failure';
    protected const UPDATE_SUCCESS = 'framework:update-success';
    protected const UPDATE_FAILURE = 'framework:update-failure';
    protected const DELETE_SUCCESS = 'framework:delete-success';
    protected const DELETE_FAILURE = 'framework:delete-failure';

    protected const LOG_MSG_CREATE_FAILURE = 'Creating %1$s failed.';
    protected const LOG_MSG_CREATE_SUCCESS = 'Creating %1$s was successful.';
    protected const LOG_MSG_UPDATE_FAILURE = 'Updating %1$s with id "%2$s" failed.';
    protected const LOG_MSG_UPDATE_SUCCESS = 'Updating %1$s with id "%2$s" was successful.';
    protected const LOG_MSG_DELETE_FAILURE = 'Deleting %1$s with id "%2$s" failed.';
    protected const LOG_MSG_DELETE_SUCCESS = 'Deleting %1$s with id "%2$s" was successful.';
