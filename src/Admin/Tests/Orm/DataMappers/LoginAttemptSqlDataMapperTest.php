...
{
    protected LoginAttemptSqlDataMapper $sut;
    ...
    public function testAdd()
    {
        ...
        $sql0       = 'INSERT INTO login_attempts (id, ip_hash, username, ip_address) VALUES (?, ?, ?, ?)'; // phpcs:ignore
        $values     = [
    ...
    public function testDelete()
    {
        ...
        $sql0       = 'DELETE FROM login_attempts AS login_attempts WHERE (id = ?)'; // phpcs:ignore
    ...
    public function testGetAll()
    {
        ...
        $sql0         = 'SELECT login_attempts.id, login_attempts.ip_hash, login_attempts.username, login_attempts.ip_address FROM login_attempts'; // phpcs:ignore
        $values       = [];
        $expectedData = [
    ...
    public function testUpdate()
    {
        ...
        $sql0       = 'UPDATE login_attempts AS login_attempts SET ip_hash = ?, username = ?, ip_address = ? WHERE (id = ?)'; // phpcs:ignore
        $values     = [
            [$ipHash, \PDO::PARAM_STR],
            [$username, \PDO::PARAM_STR],
            [null, \PDO::PARAM_NULL],
