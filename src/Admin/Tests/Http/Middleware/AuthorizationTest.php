...
namespace AbterPhp\Admin\Tests\Http\Middleware;
...
class AuthorizationTest extends TestCase
{
    ...
    protected array $parametersStub = ['resource' => self::RESOURCE, 'role' => self::ROLE];

    /** @var array<string,string> */
    protected array $sessionDataStub = ['username' => self::USERNAME];
