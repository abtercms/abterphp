...
abstract class Base implements IFormFactory
{
    ...
    {
        $this->form[] = new Input('', Input::NAME_HTTP_METHOD, $method, [], [Html5::ATTR_TYPE => Input::TYPE_HIDDEN]);
    }
    ...
    protected function addDefaultElements(): Base
    {
        ...
        $this->form[] = new Input($name, $name, $value, [], [Html5::ATTR_TYPE => Input::TYPE_HIDDEN]);
